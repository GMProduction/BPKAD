...
@section('content')
    <div class="mt-[-89px]  h-[350px] w-[100%] bg-black/50 z-[-1]  relative">
        <div class="absolute  sm:bottom-[100px] bottom-[50px]  z-1 opacity-100 w-[100%] text-center">
            <a class="font-bold text-primary  text-2xl mb-3 inline-block mr-3">Perbendaharaan dan Akuntansi </a> <a class="font-bold text-4xl text-white inline-block ">BPKAD</a> <br>
