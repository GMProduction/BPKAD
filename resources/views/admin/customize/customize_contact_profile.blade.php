...
@section('content')
    <div class="panel h-full">
        ...
        <div class="p-5 border bg-white shadow-md">
            <form method="post" action="{{ route('customize.contact.profile.patch') }}">
                @csrf
                ...
                <div class="flex flex-col md:flex-row justify-between md:gap-4">
                    <div class="mb-6 w-full">
                        ...
                        <input type="text" id="email" name="email"
                            ...
                            value="{{ old('email', $data ? $data->email : '') }}" placeholder="Email" required>
                    </div>
                    <div class="mb-6 w-full">
                        <label for="phone" class="block mb-2 text-sm font-medium text-gray-600 ">Telp</label>
                        <input type="text" id="phone" name="phone"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm  block w-full p-2.5 "
                            value="{{ old('phone', $data ? $data->phone : '') }}" placeholder="Nomor Telepon" required>
                    </div>
                ...
                <div class="mb-6 md:w-[50%]">
                    ...
                    <input type="text" id="instagram" name="instagram"
                        value="{{ old('instagram', $data ? $data->instagram : '') }}"
                ...
                <div class="mb-6 md:w-[50%]">
                    ...
                    <input type="text" id="Twitter" name="twitter"
                        value="{{ old('twitter', $data ? $data->twitter : '') }}"
                ...
                <div class="mb-6 md:w-[50%]">
                    <label for="facebook" class="block mb-2 text-sm font-medium text-gray-600 ">Facebook</label>
                    <input type="text" id="facebook" name="facebook"
                        value="{{ old('facebook', $data ? $data->facebook : '') }}"
                        class="bg-gray-50 border {{ $errors->has('facebook') ? 'border-red-500' : 'border-gray-300' }} text-gray-900 text-sm  block w-full p-2.5 "
                        v placeholder="https://www.facebook.com/akun_facebook">
                ...
                <div class="mb-6 md:w-[50%]">
                    <label for="youtube" class="block mb-2 text-sm font-medium text-gray-600 ">Youtube</label>
                    <input type="text" id="youtube" name="youtube"
                        value="{{ old('youtube', $data ? $data->youtube : '') }}"
