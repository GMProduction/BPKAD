                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="/admin/aspirasi/detail"
                            class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2  ">Detail</a>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <form>
            <div class="mb-6 sm:w-[50%]">
                <label for="aspirasi-nama"
                    class="block mb-2 text-sm font-medium text-gray-600 ">Nama</label>
            ...
            <div class="mb-6">
                <label for="aspirasi-text" class="block mb-2 text-sm font-medium text-gray-600 ">
                    Aspirasi</label>
                <textarea type="text" id="aspirasi-text" rows="4" readonly
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm  block w-full p-2.5 " placeholder="Aspirasi"
                    required></textarea>
            </div>

            <div class="mb-6 flex justify-between items-end">
                <div class=" ">
                    <label class="block mb-2 text-sm font-medium text-gray-600" for="user_avatar">File Terkait</label>
                    <button type="button" onclick="location.href='/admin/aspirasi/detail'"
                        class="flex items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2   focus:outline-none ">
