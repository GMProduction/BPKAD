                ...
                <table id="example" class="stripe hover " style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center"><button type="button" onclick="location.href='/admin/aspirasi/detail'"
                                    class="mx-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2   focus:outline-none ">Detail</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
