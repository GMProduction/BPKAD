                ...
                <ul
                    ...
                    <li class="group">
                        ...
                        <ul
                            class="py-1 text-sm text-gray-700 absolute hidden  rounded-md group-hover:block bg-white  duration-300">
                            <li>
                                <a href="/produkhukumperda" class="block py-2 px-4 hover:bg-gray-100  ">Produk Hukum
                                    Perda</a>
                            </li>
                            <li>
                                <a href="/produkhukumperwali" class="block py-2 px-4 hover:bg-gray-100  ">Produk
                                    Hukum Perwali</a>
                            </li>
    ...
    <div class="bg-transparent curved">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#23569F" fill-opacity="1"
                d="M0,256L60,245.3C120,235,240,213,360,197.3C480,181,600,171,720,181.3C840,192,960,224,1080,224C1200,224,1320,192,1380,176L1440,160L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z">
            </path>
        </svg>

        <footer class="sm:mt-[-40px] md:mt-[-60px] mt-[-0]">
            <div class=" min-h-[500px] bg-primary sm:px-16 px-10 sm:pb-16 pb-10 sm:pt-10 pt-5">
                <div class="grid md:grid-cols-4 sd:grid-cols-3 grid-cols-2 gap-10">
                    <div class="col-span-2">
                        ...
                        <p class="text-white/80 text-sm font-light mb-6 text-justify" data-aos="fade-up"
                            id="short_his">
                        </p>
