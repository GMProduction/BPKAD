...
@section('content')
    ...
    <div class=" mt-16 mb-16">
        ...
        <div class="bg-white p-10 md:w-[60%] sm:w-[75%] w-[95%] mx-auto shadow-md mb-6">
            ...
            <p class="text-sm text-center  mx-auto">TERWUJUDNYA PENGELOLAAN KEUANGAN DAN ASET
                DAERAH
                YANG AKUNTABEL DAN TRANSPARAN</p>
        </div>
        <div class="bg-white p-10 md:w-[60%] sm:w-[75%] w-[95%] mx-auto shadow-md mb-6">
            <p class="text-primary font-bold text-3xl italic mb-3 text-center ">Misi</p>
            <p class="text-sm text-center  mx-auto mb-3">1. MENINGKATKAN KELANCARAN DAN
                KETERTIBAN
                PENGELOLAAN KEUANGAN DAN ASET DAERAH SESUAI DENGAN PERATURAN YANG BERLAKU</p>
            <p class="text-sm text-center  mx-auto mb-3">2. MEWUJUDKAN PENGELOLAAN KEUANGAN
                DAERAH
                YANG EFEKTIF, EFISIEN, SERTA AKUNTABLE DENGAN MEMPERHATIKAN ASAS KEPATUTAN DAN KEADILAN</p>
            <p class="text-sm text-center  mx-auto mb-3">3. MENINGKATKAN PEMBERDAYAAN ASET
                DAERAH
        ...
        <div class="bg-white p-10 md:w-[60%] sm:w-[75%] w-[95%] mx-auto shadow-md mb-6">
            ...
            <div class="w-full text-center">
                <a href="{{ asset('assets/local/struktur.png') }}" target="_blank">
                <img src="{{ asset('assets/local/struktur.png') }}" class="  object-cover w-[80%] mx-auto " />
            </a>
            </div>
        </div>
    </div>
