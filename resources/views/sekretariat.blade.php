...
@section('content')
    <div class="page-content">
        ...
        <img class="background-image" src="{{ asset('assets/local/skretariat.png') }}" alt="Background" />
    </div>


    <x-panel-content title="Tugas Sekretariat" cardStyle="margin-bottom: 10px; margin-top: 50px;">
